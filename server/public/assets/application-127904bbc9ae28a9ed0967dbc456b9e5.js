...
(function() {
  ...
  $(document).on('ready page:load', function() {
    $('#btnSaveAndSubmit').click(function(e) {
      e.preventDefault();
      return $('#popoverNotConnected').show('slide');
    });
    $('#btnSaveAndSubmitOk').click(function(e) {
      e.preventDefault();
      return $('#popoverNotConnected').hide('slide', function() {
        return Turbolinks.visit('/users/done');
      });
    });
    $('#btnSaveAddClientContact').click(function(e) {
      $('#clientContactsEmptyRecord').remove();
      $('#clientContactsSampleRecord').show(500);
      return e.preventDefault();
    });
    $('#btnAddClientContact, #btnSaveAddClientContact, #btnCancelAddClientContact').click(function(e) {
      if (gToggle) {
      ...
      return gToggle = !gToggle;
    });
    $('#btnGeneratePolicyRequest').click(function(e) {
      e.preventDefault();
      $('#popoverGeneratePolicyRequest').show('slide');
      return $('body').addClass('popover-active');
    });
    $('#btnGeneratePolicyRequestOk').click(function(e) {
      e.preventDefault();
      $('#btnGeneratePolicyRequest').html('<i class="icon-ok"></i> Generate Policy Request').addClass('pure-button-disabled');
      $('#popoverGeneratePolicyRequest').hide('slide');
      return $('body').removeClass('popover-active');
    });
    $('#btnSaveAddMiscNote').click(function(e) {
      $('#miscNoteEmptyRecord').remove();
      return $('#miscNoteSampleRecord').show(500);
    });
    $('#btnAddMiscNote, #btnSaveAddMiscNote, #btnCancelAddMiscNote').click(function(e) {
      if (gToggle) {
        $('body').removeClass('popover-active');
    ...
    $('#btnSaveAddPhoto').click(function(e) {
      $('#photoEmptyRecord').remove();
      return $('#photoSampleRecord').show(500);
    });
    return $('#btnAddPhoto, #btnSaveAddPhoto, #btnCancelAddPhoto').click(function(e) {
      if (gToggle) {
        $('body').removeClass('popover-active');
